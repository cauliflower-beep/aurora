...
type EncoderData struct {
	lengthField            aiface.LengthField
...
func NewLengthFieldFrameDecoderByLengthField(lengthField aiface.LengthField) aiface.ILengthField {
	c := &EncoderData{
...
func NewLengthFieldFrameDecoder(maxFrameLength uint64, lengthFieldOffset, lengthFieldLength, lengthAdjustment, initialBytesToStrip int) aiface.ILengthField {
	return NewLengthFieldFrameDecoderByLengthField(aiface.LengthField{
